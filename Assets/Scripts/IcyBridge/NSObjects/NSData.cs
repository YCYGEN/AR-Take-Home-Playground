...
namespace YCYShells.IcyBridge
{
    ...
    public struct NSData : IDisposable, IEquatable<NSData>
    {
        ...
        [DllImport("__Internal", EntryPoint="IcyBridge_NSData_getLength")]
        static extern int GetLength(NSData self);

        [DllImport("__Internal", EntryPoint="IcyBridge_NSData_getBytes")]
        static extern unsafe void* GetBytes(NSData self);

        [DllImport("__Internal", EntryPoint="IcyBridge_NSData_createWithBytes")]
        static extern unsafe IntPtr CreateWithBytes(void* bytes, int length);

        [DllImport("__Internal", EntryPoint="IcyBridge_NSData_createWithBytesNoCopy")]
