...
namespace YCYShells.IcyBridge
{
    ...
    public struct NSString : IDisposable, IEquatable<NSString>
    {
        ...
        [DllImport("__Internal", EntryPoint="IcyBridge_NSString_createWithString")]
        static extern IntPtr CreateWithString([MarshalAs(UnmanagedType.LPWStr)] string text, int length);

        [DllImport("__Internal", EntryPoint="IcyBridge_NSString_lengthOfBytesUsingEncoding")]
        static extern int GetLengthOfBytes(NSString self);

        [DllImport("__Internal", EntryPoint="IcyBridge_NSString_getLength")]
        static extern int GetLength(NSString self);

        [DllImport("__Internal", EntryPoint="IcyBridge_NSString_getBytes")]
        static extern unsafe bool GetBytes(NSString self, void* buffer, int length);

        [DllImport("__Internal", EntryPoint="IcyBridge_NSString_serialize")]
        static extern NSData Serialize(NSString self);

        [DllImport("__Internal", EntryPoint="IcyBridge_NSString_deserialize")]
